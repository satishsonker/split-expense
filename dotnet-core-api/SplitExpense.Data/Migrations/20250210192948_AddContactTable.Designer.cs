...
namespace SplitExpense.Data.Migrations
{
    ...
    [Migration("20250210192948_AddContactTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SplitExpense.Models.Contact", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SplitExpense.Models.Expense", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SplitExpense.Models.ExpenseNote", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SplitExpense.Models.ExpenseShare", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SplitExpense.Models.SplitType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SplitExpense.Models.Transaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SplitExpense.Models.Contact", b =>
                {
                    b.HasOne("SplitExpense.Models.User", "ContactUser")
                        .WithMany()
            ...
            modelBuilder.Entity("SplitExpense.Models.Expense", b =>
                {
                    ...
                    b.HasOne("SplitExpense.Models.User", "PaidByUser")
                        .WithMany()
                        .HasForeignKey("PaidByUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SplitExpense.Models.SplitType", "SplitType")
                        .WithMany()
            ...
            modelBuilder.Entity("SplitExpense.Models.ExpenseNote", b =>
                {
                    b.HasOne("SplitExpense.Models.Expense", "Expense")
                        .WithMany()
            ...
            modelBuilder.Entity("SplitExpense.Models.Transaction", b =>
                {
                    b.HasOne("SplitExpense.Models.User", "FromUser")
                        .WithMany()
                        .HasForeignKey("FromUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SplitExpense.Models.User", "ToUser")
                        .WithMany()
            ...
            modelBuilder.Entity("SplitExpense.Models.UserGroupMapping", b =>
                {
                    ...
                    b.HasOne("SplitExpense.Models.User", "AddedUser")
                        .WithMany()
                        .HasForeignKey("FriendId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
