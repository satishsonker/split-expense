const env = {
    ...
    BASE_URL_API:process.env.REACT_APP_API_BASE_URL || 'http://93.127.137.173/splitExpenseApi/',
    API_URL: process.env.REACT_APP_API_BASE_URL+process.env.REACT_APP_API_SUFFIX || 'http://93.127.137.173/splitExpenseApi/api/v1',
